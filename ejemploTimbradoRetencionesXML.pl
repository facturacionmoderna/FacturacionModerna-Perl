...
load getcwd . '/FacturacionModerna/manipularXML.pl';
load getcwd . '/FacturacionModerna/service.pl';
...
$xml = FacturacionModerna::manipularXML::generarXMLRetenciones($rfc,$numero_certificado);
$xml_sellado = FacturacionModerna::manipularXML::sellarRetenciones($xml, $archivo_cer, $archivo_pem);
